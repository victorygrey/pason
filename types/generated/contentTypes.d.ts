...
export interface ApiListItemTransactionListItemTransaction
  extends Struct.CollectionTypeSchema {
...
export interface ApiMerchantProductMerchantProduct
  extends Struct.CollectionTypeSchema {
...
export interface ApiMerchantMerchant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    merchant_account_number: Schema.Attribute.String &
      Schema.Attribute.Required;
    merchant_address: Schema.Attribute.Text & Schema.Attribute.Required;
    merchant_description: Schema.Attribute.Text;
    merchant_name: Schema.Attribute.String & Schema.Attribute.Required;
    merchant_products: Schema.Attribute.Relation<
      'oneToMany',
      'api::merchant-product.merchant-product'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_app: Schema.Attribute.Relation<'oneToOne', 'api::userapp.userapp'>;
  };
}
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    features: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    judul: Schema.Attribute.String & Schema.Attribute.Required;
    konten: Schema.Attribute.Blocks & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vitamin: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_app: Schema.Attribute.Relation<'manyToOne', 'api::userapp.userapp'>;
  };
}
...
export interface ApiUserappUserapp extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['merchant', 'client']> &
      Schema.Attribute.Required;
    transactions: Schema.Attribute.Relation<
      'oneToMany',
      'api::transaction.transaction'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::list-item-transaction.list-item-transaction': ApiListItemTransactionListItemTransaction;
      'api::merchant-product.merchant-product': ApiMerchantProductMerchantProduct;
      'api::merchant.merchant': ApiMerchantMerchant;
      'api::post.post': ApiPostPost;
      'api::product.product': ApiProductProduct;
      'api::transaction.transaction': ApiTransactionTransaction;
      'api::userapp.userapp': ApiUserappUserapp;
