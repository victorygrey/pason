...
const indexUBwCyQ_3 = require("./index-UBwCyQ_3-lG3F5mWr.js");
...
const index = require("./index-6xS_NVnz.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexUBwCyQ_3.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexUBwCyQ_3.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexUBwCyQ_3.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-CzxZzlFc.js.map
