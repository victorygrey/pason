...
import { b as Layouts, v as ContentBox } from './index-UBwCyQ_3.mjs';
import { m as useGuidedTour, c as useTracking, e as useAPIErrorHandler, a as useNotification, P as Page, p as useAppInfo } from './Theme-Cw2LYZGD.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-BLO4BMS9.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-D3Uf6UN4.mjs.map
