...
import { b as Layouts } from './index-UBwCyQ_3.mjs';
import { c as useTracking, r as useConfiguration, p as useAppInfo, k as useRBAC, P as Page } from './Theme-Cw2LYZGD.mjs';
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import('./AdminSeatInfo-BaUlvJzw.mjs')).AdminSeatInfoEE
  );
  const {
...
//# sourceMappingURL=ApplicationInfoPage-Ks5SLUGu.mjs.map
