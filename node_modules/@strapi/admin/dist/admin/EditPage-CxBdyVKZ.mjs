...
import { b as useTypedSelector, P as Page, a as useNotification, e as useAPIErrorHandler } from './Theme-Cw2LYZGD.mjs';
...
import { u as useField, w as useForm, x as MemoizedStringInput, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-UBwCyQ_3.mjs';
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import('./EventsTable-CPOsecQe.mjs')).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-CxBdyVKZ.mjs.map
